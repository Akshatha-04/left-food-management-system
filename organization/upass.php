...
<?php
	...
	$acheck=mysqli_query($con,"select * from organization where password='$opass' and id='$sid'");

	
	if(mysqli_num_rows($acheck)!=0)
	{
				if(mysqli_query($con,"UPDATE `organization` SET `password`='$npass' WHERE `password`='$opass' and id='$sid'"))
					{
